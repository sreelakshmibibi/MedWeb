...
class StaffProfile extends Model
{
    ...
    protected static function booted()
    {
        ...
        static::deleting(function ($staffProfile) {
            $staffProfile->deleted_by = Auth::id(); // Set updated_by to current user's ID
        });
    }
