...
class ToothExamination extends Model
{
    ...
    use SoftDeletes;
    protected $fillable = [
        'patient_id', 'app_id', 'tooth_id', 'tooth_score_id', 'chief_complaint', 'hpi', 'dental_examination', 'disease_id','diagnosis', 'treatment_id', 'x-ray', 'lingual_condn', 'labial_condn', 'occulusal_condn', 'distal_condn', 'mesial_condn', 'palatal_condn', 'buccal_condn', 'treatment_status', 'anatomy_image', 'created_by', 'updated_by', 'status'
    ];
