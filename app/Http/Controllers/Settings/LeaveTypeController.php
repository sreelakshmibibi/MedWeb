...
class LeaveTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $leaveType = LeaveType::select('leave_types.*', 'employee_types.employee_type as emp_type')
                ->join('employee_types', 'employee_types.id', '=', 'leave_types.employee_type_id')->orderBy('type', 'asc')->get();
        ...
        return view('settings.leaveType.index', compact('employeeType'));
    }
    ...
    public function store(LeaveTypeRequest $request): JsonResponse
    {
        try {
            ...
            $leaveType = LeaveType::create([
                ...
                'employee_type_id' => $request->emp_type,
    ...
    public function update(Request $request)
    {
        ...
        $leaveType->employee_type_id = $request->input('edit_emp_type');
