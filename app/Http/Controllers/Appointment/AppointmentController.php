            ...
            return DataTables::of($appointments)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $buttons = [
                        ...
                        "<button type='button' class='waves-effect waves-light btn btn-circle btn-danger btn-xs' data-bs-toggle='modal' data-bs-target='#modal-cancel' data-id='{$row->id}' title='cancel'><i class='fa fa-times'></i></button>",
                    ];
