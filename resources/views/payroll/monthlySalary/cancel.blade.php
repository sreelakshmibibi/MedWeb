<form id="form-cancel-salary" method="POST">
    @csrf
    <!-- delete modal-->
    <div class="modal fade" id="modal-cancel-salary-bill" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Cancel Salary</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to cancel the salary entered?</p>
