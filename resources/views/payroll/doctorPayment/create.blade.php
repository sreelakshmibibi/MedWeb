...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-full">
            ...
            <section class="content">
                <form id="doctorPaymentForm" method="post"
                    action="{{ route('doctorPayment.store')  }}">
                    @csrf
                        ...
                        <div class="box">
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label" for="doctor">Total Paid : </label>
                                            {{ $totalPaid }}
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        var doctorPaymentUrlCreate = "{{ route('doctorPayment.create', ':userId') }}".replace(':userId', userId); // Replace placeholder with encoded user ID   
    </script>
