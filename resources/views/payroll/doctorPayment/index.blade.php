...
@section('title', 'Visiting Doctor Payments')
@section('content')
        ...
        <div class="container-full">
            <div class="content-header">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <h3 class="page-title">Visiting Doctors</h3>
...
@section('scripts') --}}
    ...
    <script>
        var doctorPaymentUrl = "{{ route('doctorPayment') }}";
    </script>

    <!-- custom JavaScript file -->
    <script src="{{ asset('js/doctorPayment.js') }}"></script>
