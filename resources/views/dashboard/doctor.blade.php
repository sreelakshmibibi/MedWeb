...
@section('content')
                                ...
                                @foreach ($currentappointments as $currentappointment)
                                    <div class="mb-10 d-flex justify-content-between align-items-center">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="me-10 avatar bg-primary-light rounded-circle b-1 text-bold">
                                            ...
                                            <div>
                                                ...
                                                <button type='button'
                                                    ...
                                                    title='reschedule'><i class='fa-solid fa-calendar-days'></i></button>
                                                <button type='button'
    ...
    <script>
        $(document).ready(function() {
            ...
            // Example of the AJAX request to fetch the data
