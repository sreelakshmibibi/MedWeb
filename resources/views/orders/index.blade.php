                    ...
                    <div class="box-body">
                        <form method="post" action="{{ route('orders.store') }}" id="orderForm">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3 col-lg-2">
                                    <button type="submit" class="btn btn-success" id="searchPlaceOrderBtn">
                            ...
                            <div id="orderResults" style="display:none; margin-top: 20px;">
                                <div class="box-footer p-3" style="border-radius: 0px;">
                                    <h4 class="form-label text-center">Place Order</h4>
                                    <div class="box-footer p-3" style="border-radius: 0px;"></div>
                                    ...
                                    <div class="row" id="order_place_section1">
                                        ...
                                        <div class="col-md-3 col-lg-2">
                                            <div class="form-group">
                                                <label class="form-label" for="delivery_expected">Delivery Expected on <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row" id="order_place_section2">
                                        <div class="col-md-3 col-lg-2">
                                            <label class="form-label" for="selectRow">Select Patients <span class="text-danger">*</span>
                                            </label>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data.length === 0) {
                        ...
                        $('#tableContainer').html('<p class="text-center">No treatment plans pending to order.</p>');
                        $('#orderResults').show();
                        ...
                        tableHtml += '<thead><tr><th class="text-center">Select</th><th class="text-center">Patient ID</th><th class="text-center">Patient Name</th><th class="text-center">Tooth</th><th class="text-center">Plan</th><th class="text-center">Shade</th><th class="text-center">Instructions</th></tr></thead><tbody>';

                        $.each(data, function(index, item) {
                            tableHtml += '<tr>';
                            tableHtml += '<td class="text-center">';
                            tableHtml += `<input type="checkbox" id="checkbox${index}" name="selectRow[]" value="${item.id}" class="filled-in chk-col-success" />`;
