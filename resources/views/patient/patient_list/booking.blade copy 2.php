                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-none row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <div class="input-group mb-0">
                                        <span class="input-group-text"><i class="fas fa-wine-glass"></i></span>
                                        <select class="form-select" id="smoking_status" name="smoking_status">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.existingAppointments.length > 0) {
                        ...
                        var table = $('<table class="table table-striped ">').addClass(
                        ...
                        for (var i = 0; i < numRows; i++) {
                            ...
                            for (var j = 0; j < 3; j++) {
                                ...
                                if (dataIndex < data.existingAppointments.length) {
                                    var cell = $('<td class="b-1 w-100 text-center">').text(data
