            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control " type="text" id="doctor" name="doctor">
                            <option value="">All</option>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" placeholder="From" aria-label="From" name="pAgeFrom" id="pAgeFrom" min="0" max="99">
                            <span class="input-group-text">-</span>
                            <input type="number" class="form-control" placeholder="To" aria-label="To" name="pAgeTo" id="pAgeTo" min="0" max="99">
                        </div>
                    </div>
                </div>
