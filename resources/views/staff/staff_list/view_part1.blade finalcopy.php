<div class="row">
    <div class="col-xl-8 col-12">
        <div class="box ">
            <div class="box-body ribbon-box">
                {{-- <div class="box-body d-flex align-items-center ribbon-box"> --}}
                {{-- <div class="ribbon ribbon-success"
                    style="margin-right: -30px; float: right;
    margin-left: 0;
    margin-right: -30px;"><i
                        class="fa-solid fa-user-doctor"></i> Surgeon</div> --}}
    ...
    border-bottom-left-radius: 10px;">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="rounded10 p-15 fs-18 d-inline min-h-50 @php echo ($staffProfile->status == 'Y') ? 'bg-success' : 'bg-danger'; @endphp"
                        style="display: none;">
            ...
            <div class="box-body staff-section" style="display: none;">
                ...
                <ul class="nav d-block nav-stacked py-0 ">
                    <div class="row">
                        ...
                        {{-- <div class="col bs-1 border-light ps-20"> --}}
                        <div class="col  ps-20">
                            <li class="nav-item d-flex justify-start align-items-center">
                                <div class="min-w-120 text-muted">
                                    Gender
            ...
            <div class="box-body doctor-section pt-0" style="display: none;">
                ...
                {{-- <p>@php echo str_replace('<br>', ' ', $userDetails->name); @endphp is an experienced dentist specializing in {{ $staffProfile->specialization }},
                    ...
                    compassionate care and achieving optimal oral health outcomes for his patients. @php echo str_replace('<br>', ' ', $userDetails->name); @endphp
                    stays
                    updated with the latest advancements in dentistry to ensure his patients receive the highest quality
                    of care possible.</p> --}}
                <p>@php echo str_replace('<br>', ' ', $userDetails->name); @endphp is an experienced dentist specializing in {{ $staffProfile->specialization }},
                ...
                {{-- <ul class="flexbox flex-justified text-center p-10"> --}}
        ...
        <div class="row doctor-section" style="display: none;">
            {{-- <div class="col-md-6 col-12"> --}}<div class="col-md-9 col-12">
                <div class="box">
    ...
    <div class="col-xl-4 col-12">
        ...
        <div class="box " style="display: none;">
            <div class="box-body box-profile">
                ...
                <div class="d-flex align-items-center mb-1 ">
                    {{-- <div class="me-15 text-center text-muted">
                        <span class=" fs-24"><i class="fa fa-suitcase"></i></span>
                    </div> --}}
                    <div class="d-flex flex-column ">
                        <span class="text-muted">Department</span>
                        <div class=" mb-1 fs-16 fw-500">
                ...
                <div class="d-flex align-items-center ">
                    {{-- <span class="fs-12"><i class="fa fa-brands"></i></span> --}}
            ...
            <div class="box-body box-profile">
                ...
                <div class="d-flex align-items-center mb-1 ">
                    ...
                    <div class="d-flex flex-column fw-500">
                        <span class="text-fade">Department</span>
                        <div class="text-dark hover-primary mb-1 fs-16">
                            @php
                                echo $departments->firstWhere('id', $staffProfile->department_id)->department ?? '';
                            @endphp
                        </div>
                ...
                <div class="d-flex align-items-center ">
                    ...
                    <div class="d-flex flex-column fw-500">
                        <span class="text-fade">Branch</span>
                        <div class="text-dark hover-primary mb-1 fs-16">
                            @php
                                $clinicAddress =
                                    $clinicBranches->firstWhere('id', $staffProfile->clinic_branch_id)
