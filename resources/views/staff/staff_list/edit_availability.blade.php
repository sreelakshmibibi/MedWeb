            ...
            <tbody id="tablebody">
                ...
                @foreach ($availableBranches as $branch)
                    <tr>
                        <td>{{ $i }}</td>
                        <td>
                            <select class="form-control clinic_branch_select" id="clinic_branch_id{{ $i }}"
                                name="clinic_branch_id{{ $i }}" required>
                                @foreach ($clinicBranches as $clinicBranch)
                                    ...
                                    <option value="{{ $clinicBranch->id }}"
                                        @if ($branch['clinic_branch_id'] == $clinicBranch->id) selected @endif>
                                        {{ $branchName }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                            <input type="time" class="form-control timeInput fromTime"
                                id="sunday_from{{ $i }}" title="from" name="sunday_from{{ $i }}"
                                style="width:115px;" value="{{ $branch['timings']['sunday_from'] ?? '' }}">
                            ...
                            <span class="error-message text-danger" id="error_sunday_from{{$i}}"></span>
                        </td>
                        <td>
                            <input type="time" class="form-control timeInput fromTime"
                                id="monday_from{{ $i }}" name="monday_from{{ $i }}"
                                title="from" style="width:115px;"
                                value="{{ $branch['timings']['monday_from'] ?? '' }}">
                            <input type="time" class="form-control timeInput toTime"
                                id="monday_to{{ $i }}" name="monday_to{{ $i }}" title="to"
                                style="width:115px;" value="{{ $branch['timings']['monday_to'] ?? '' }}">
                            <span class="error-message text-danger" id="error_monday_from{{$i}}"></span>
                        </td>
                        <td>
                            <input type="time" class="form-control timeInput fromTime"
                                id="tuesday_from{{ $i }}" name="tuesday_from{{ $i }}"
                                title="from" style="width:115px;"
                                value="{{ $branch['timings']['tuesday_from'] ?? '' }}">
                            <input type="time" class="form-control timeInput toTime"
                                id="tuesday_to{{ $i }}" name="tuesday_to{{ $i }}" title="to"
                                style="width:115px;" value="{{ $branch['timings']['tuesday_to'] ?? '' }}">
                            <span class="error-message text-danger" id="error_tuesday_from{{$i}}"></span>
                        </td>
                        <td>
                            <input type="time" class="form-control timeInput fromTime"
                                id="wednesday_from{{ $i }}" name="wednesday_from{{ $i }}"
                                title="from" style="width:115px;"
                                value="{{ $branch['timings']['wednesday_from'] ?? '' }}">
                            <input type="time" class="form-control timeInput toTime"
                                id="wednesday_to{{ $i }}" name="wednesday_to{{ $i }}"
                                title="to" style="width:115px;"
                                value="{{ $branch['timings']['wednesday_to'] ?? '' }}">
                            <span class="error-message text-danger" id="error_friday_from{{$i}}"></span>
                        </td>
                        <td>
                            <input type="time" class="form-control timeInput fromTime"
                                id="thursday_from{{ $i }}" name="thursday_from{{ $i }}"
                                title="from" style="width:115px;"
                                value="{{ $branch['timings']['thursday_from'] ?? '' }}">
                            <input type="time" class="form-control timeInput toTime"
                                id="thursday_to{{ $i }}" name="thursday_to{{ $i }}"
                                title="to" style="width:115px;"
                                value="{{ $branch['timings']['thursday_to'] ?? '' }}">
                            <span class="error-message text-danger" id="error_thursday_from{{$i}}"></span>
                        </td>
                        <td>
                            <input type="time" class="form-control timeInput fromTime"
                                id="friday_from{{ $i }}" name="friday_from{{ $i }}"
                                title="from" style="width:115px;"
                                value="{{ $branch['timings']['friday_from'] ?? '' }}">
                            <input type="time" class="form-control timeInput toTime"
                        ...
                        <td>
                            <input type="time" class="form-control timeInput fromTime"
                                id="saturday_from{{ $i }}" name="saturday_from{{ $i }}"
                                title="from" style="width:115px;"
                                value="{{ $branch['timings']['saturday_from'] ?? '' }}">
                            <input type="time" class="form-control timeInput toTime"
                                id="saturday_to{{ $i }}" name="saturday_to{{ $i }}"
                                title="to" style="width:115px;"
                                value="{{ $branch['timings']['saturday_to'] ?? '' }}">
                            <span class="error-message text-danger" id="error_saturday_from{{$i}}"></span>
                        </td>
                        <td>
