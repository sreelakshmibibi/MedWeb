<?php
    ...
    $trialPeriod = $trialService->isTrialValid();
 ?>
@extends('layouts.app')
@section('title', 'Login')
@section('content')
    {{-- <div class="container h-p100"> --}}
    <div class="row align-items-center justify-content-md-center justify-content-center h-p100">
        @if ($trialPeriod)
        ...
        <div class="col-10 col-md-12">
                <div class="row justify-content-center g-0">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="bg-white rounded10 shadow-lg">
                            <div class="content-top-agile p-20 pb-0">
                                <h2 class="text-primary">Your trial period has expired. </h2>
                                <h4 class="mb-0">Please reach out to the administrator for assistance.</h4>
                            </div>
                            <div class="p-20">
