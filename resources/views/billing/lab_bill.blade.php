                        ...
                        <div class="box no-border mb-0" id="labBillResults" style="display:none;">
                            ...
                            <div class="box-body">
                                <div class="row" id="bill_place_section1">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label" for="bill_amount">Bill Amount <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label" for="previous_due">Previous Due <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label" for="order_date">Net Amount to be paid <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="amount_to_be_paid"
                                                name="amount_to_be_paid" required disabled>
                                        </div>
                                    </div>

                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label" for="payment_through">Payment
                                                through<span class="text-danger">*</span></label>
                                            <select class="form-control form-select" id="payment_through"
                                    ...
                                    <div class="col-lg-3" id="paymentmodediv">
                                        <div class="form-group">
                                            <label class="form-label" for="mode_of_payment">Mode of Payment<span
                                                    class="text-danger">*</span></label>
                                            <br>

                                            <!-- Checkbox for Gpay -->
                                            <input type="checkbox" class="filled-in chk-col-success"
                                                id="mode_of_payment_gpay" name="mode_of_payment[]" value="gpay">
                                            <label class="form-check-label me-2" for="mode_of_payment_gpay">Gpay</label>
                                            <input type="text" name="gpaycash" id="gpaycash"
                                                class="form-control  w-100 " style="display: none;">
                                            &nbsp;
                                            <!-- Checkbox for Cash -->
                                            <input type="checkbox" class="filled-in chk-col-success"
                                                id="mode_of_payment_cash" name="mode_of_payment[]" value="cash">
                                            <label class="form-check-label me-2" for="mode_of_payment_cash">Cash</label>
                                            <input type="text" name="cash" id="cash"
                                                class="form-control  w-100" style="display: none;">
                                            &nbsp;
                                            <!-- Checkbox for Card -->
                                            <input type="checkbox" class="filled-in chk-col-success"
                                                id="mode_of_payment_card" name="mode_of_payment[]" value="card">
                                            <label class="form-check-label me-2" for="mode_of_payment_card">Card</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label" for="amount_paid">Amount paid <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="amount_paid"
                                                name="amount_paid" required readonly>

                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label" for="balance_due">Balance Due<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="balance_due"
                                                name="balance_due" required disabled>
    ...
    <script type="text/javascript">
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function handleCheckboxChange() {
                ...
                // Update the paymentmodediv class based on checkbox states
                const paymentModeDiv = document.getElementById("paymentmodediv");

                if (gpayChecked || cashChecked || cardChecked) {
                    paymentModeDiv.classList.add("col-md-9", "col-lg-6"); // Add multiple classes
                    paymentModeDiv.classList.remove("col-md-6", "col-lg-3");
                } else {
                    paymentModeDiv.classList.remove("col-md-9", "col-lg-6");
                    paymentModeDiv.classList.add("col-md-6", "col-lg-3");
                }
            }
            ...
            $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (data.length === 0) {
                                ...
                                $('#tableContainer').html(
                                    '<p class="text-center">No Bills pending to pay.</p>'
                                );
                                $('#labBillResults').show();
                                ...
                                tableHtml +=
                                    '<thead><tr><th class="text-center">No.</th><th class="text-center">Patient ID</th><th class="text-center">Patient Name</th><th class="text-center">Tooth</th><th class="text-center">Plan</th><th class="text-center">Shade</th><th class="text-center">Instructions</th><th class="text-center">Amount</th></tr></thead><tbody>';
                ...
                $('#payBillOrderBtn').click(function(e) {
                    ...
                    if ($('#mode_of_payment_gpay').is(':checked')) {
                        ...
                        if (gpayAmount <= 0) {
                            $('#modeError').text(
                                'Gpay amount must be greater than zero if selected.');
                            isValid = false;
                        } else {
                    ...
                    if ($('#mode_of_payment_cash').is(':checked')) {
                        ...
                        if (cashAmount <= 0) {
                            $('#modeError').text(
                                'Cash amount must be greater than zero if selected.');
                            isValid = false;
                        } else {
                    ...
                    if ($('#mode_of_payment_card').is(':checked')) {
                        ...
                        if (cardAmount <= 0) {
                            $('#modeError').text(
                                'Card amount must be greater than zero if selected.');
                            isValid = false;
                        } else {
                    ...
                    if (isValid) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#labBillResults')
                                    .hide(); // Hide results section if needed

                                // If you have any specific fields that need to be reset to a particular value:
                                $('#serviceFromDate').val(new Date().toISOString()
                                    .split('T')[0]); // Reset to today
                                $('#serviceToDate').val(new Date().toISOString().split(
                                    'T')[0]); // Reset to today

                                // Optionally, you can clear the detailed bill table if it exists
                                $('#tableContainer').empty();
                                $('#successMessage').text(
                                    "Bill paid orders updated Successfully").show();
                                setTimeout(function() {
                                    window.location.href =
                                        "{{ route('labPayment.show') }}"; // Replace with your actual route name
                                }, 2000);
