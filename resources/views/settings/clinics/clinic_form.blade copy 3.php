...
<script type="text/javascript">
    ...
    jQuery(function($) {
        table = $('#cbranch_table').DataTable({
            ...
            .draw(); // Adjust column widths immediately after initialization
            },
            // Draw callback to adjust column widths after each redraw
            drawCallback: function(settings) {
                table.columns.adjust().draw();
            }
            // Draw callback to adjust column widths after the table is fully loaded
            // drawCallback: function(settings) {
            //     table.columns.adjust().draw();
            // }
        });
