<form id="editClinicForm" method="post" enctype="multipart/form-data" action="{{route('settings.clinic.update')}}">
    ...
    <div class="modal modal-right slideInRight" id="modal-edit-clinic" tabindex="-1">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="edit_clinic_email" name="clinic_email"
                                        placeholder="E-mail">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img id="currentClinicLogoImg" src="" alt="Current Logo" style="max-width: 100px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="url" id="edit_clinic_website" name="clinic_website"
                                        placeholder="http://">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input name="edit_branch_active" type="radio" class="form-control with-gap" id="edit_yes" value="Y" checked>
                            <label for="yes">Yes</label>
                            <input name="edit_branch_active" type="radio" class="form-control with-gap" id="edit_no" value="N">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <div>
                                <input name="status" type="radio" class="form-control-input" id="edit_medicine_yes" value="Y">
                                <label class="form-check-label" for="edit_yes">Yes</label>
                                <input name="status" type="radio" class="form-control-input" id="edit_medicine_no" value="N">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="edit_clinic_address1">Address Line
                                        1</label>
                                    <input type="text" class="form-control" id="edit_clinic_address1" name="clinic_address1"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="edit_clinic_address2">Address Line
                                        2</label>
                                    <input type="text" class="form-control" id="edit_clinic_address2" name="clinic_address2"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="edit_clinic_pincode" name="clinic_pincode"
                                        placeholder="XXX XXX">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        $('#edit_clinic_state').append('<option value="' + key + '">' + value + '</option>');
                    });
        ...
        if (stateId) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        $('#edit_clinic_city').append('<option value="' + key + '">' + value + '</option>');
                    });
                }
            });
        } else {
