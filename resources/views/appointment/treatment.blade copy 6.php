    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#presc_checkbox").change(function() {
                if ($(this).is(':checked')) {
                    // loadPrescriptionForm();
                    // $('#prescdiv').show();
                }

                // Initialize Select2 for #medicine_id1
                ...
                // // Handle change event to add new medicine to the array if it's a new tag
                // $('#medicine_id1').on('select2:select', function(e) {
            ...
            function loadPrescriptionForm() {
                // Simulate loading table with Select2 enabled fields
                var tableContent = `<table id="presctable" class="table table-bordered table-striped text-center" role="grid"
                                aria-describedby="example2_info">
                                <thead>
                                    <tr role="row" class="bg-primary-light">
                                        <th>No</th>
                <th>Medicine</th>
                <th>Dosage</th>
                ...
                // Append table content to a container div
                $('#prescriptionFormContainer').html(tableContent);

                // Initialize Select2 for dynamic select elements
                initializeSelect2ForDynamicElements();
            }
            ...
            //     if (data.newTag) {
            //         // Perform logic to add new medicine to the array
            //         var option = new Option(data.text, data.id, true, true);
            //         $(this).append(option).trigger('change');
            //     }
            // });
            function initializeSelect2ForDynamicElements() {
                // Example: Initialize Select2 for medicine_id1 (assuming it's the first row)
                $('#medicine_id1').select2({
                    placeholder: 'Select a Medicine',
                    allowClear: true,
                    tags: true,
