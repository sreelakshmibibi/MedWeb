    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#presc_checkbox").change(function() {
                if ($(this).is(':checked')) {
                    // $(".actions > ul > li:last-child > a").text("Next").css("background-color", "blue");
                    // $(".actions > ul > li:nth-child(2)").css("display", "block").attr("aria-hidden",
                    //     "false").attr("aria-disabled", "false").removeClass("disabled");
                    // $(".actions > ul > li:nth-child(2)").removeClass("disabled").css("display", "block");
                    $(".actions > ul > li:last-child").addClass("disabled").css("display", "none");
                    // $('#prescdiv').show();
                } else {
                    // $(".actions > ul > li:last-child > a").text("Save").css("background-color", "green");
                }
