...
<div class="row ">
    <div class="col-xl-8 col-12">
        <div class="box flex-grow-1 mb-3" style="border-radius: 0px; /*height: 364px;*/">
            ...
            <div class="d-none box-header  pt-3">
        ...
        <div class="row">
            <div class="col">
                <div class="box flex-grow-1 mb-3" style="border-radius: 0px; height: 195px;">
                    <div class="box-body ">
                    ...
                    <div class="box-body ">
                        ...
                        <div class="media-list  px-0">
                            ...
                            <div class="media media-single  pt-2 px-0 ">
                                <div class="media-body m-0 p-0">
                                    <span class="text-warning fs-16 "><i class="fa-solid fa-disease "></i>&nbsp;Disease
                                        History</span>
                                    <h6 class="ms-2 mt-2">
