...
@section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //     animation: "slide",
            //     slideshow: false, // Adjust options as needed
            //     // Add any additional Flexslider options here
            //     start: function(slider) {
            //         // Add any custom start actions here
            //         // Preload images inside Flexslider
            //         // preloadImages('.flexslider img');
            //     }
            // });
            ...
            //         $('<img>').attr('src', $(this).attr('src')).appendTo('body').css('display', 'none');
            //     });
            // }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        images.forEach(function(image) {
                            ...
                            // var listItem =
                            //     '<li class="fx-overlay-1"><a class="btn btn-outline image-popup-vertical-fit" href="' +
                            //     imageSrc +
                            //     '"><img src="' +
                            //     imageSrc +
                            //     '" alt="slide" /></a><p class="flex-caption" >' +
                            //     image +
                            //     '</p><div class="fx-overlay scrl-up"><ul class="fx-info"><li><a class="btn btn-outline image-popup-vertical-fit" href="' +
                            //     imageSrc +
                            //     '"><i class="fa-solid fa-magnifying-glass"></i></a></li><li><a class="btn btn-outline" href="javascript:void(0);"><i class="mdi mdi-delete"></i></a></li><li><a class="btn btn-outline" href="javascript:void(0);"><i class="mdi mdi-settings"></i></a></li></ul></div></li>';
                            // $('#imageSlides').append(listItem);
                            // var listItem =
                            //     '<li class="fx-overlay-1"><a class="btn btn-outline image-popup-vertical-fit" href="' +
                            //     imageSrc +
                        ...
                        $('.flexslider').flexslider({
                            animation: "slide",
                            // controlNav: false, // example option, customize as needed
                            // other options as needed
                            // callbacks: {
                            //     open: function() {
                            //         $('.flexslider')
                            //             .resize(); // Resize FlexSlider when Magnific Popup is opened
                            //     }
                            // }
                        });
            ...
            //             // Iterate over each image and construct HTML for FlexSlider
            //             images.forEach(function(image) {
            //                 var imageSrc = "{{ asset('storage/x-rays') }}/" +
            //                     patientId + "/" + toothId + "/" + image;

            //                 var listItem = `<li>
        //                         <div class="flex-caption">${image}</div>
        //                         <a class="image-link" href="${imageSrc}">
        ...
        //                     </li>`;
            ...
            //             // Initialize FlexSlider after appending images
            //             $('.flexslider').flexslider({
            //                 animation: "slide",
            //                 controlNav: false,
            //                 slideshow: true,
