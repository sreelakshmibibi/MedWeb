                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="row bb-1 pb-10 pt-5">
                                                                ...
                                                                <div
                                                                    class="col-4 d-flex align-content-center flex-wrap">
                                                                    <div> <img
                                                                            class="img-fluid float-start w-30 mt-10 me-10"
                                                                            src="{{ asset('images/weight.png') }}"
                                                                            alt=""></div>
                                                                    <div style="width: 60%">
                                                                ...
                                                                <div
                                                                    class="col-4 bs-1 be-1 d-flex align-content-center flex-wrap">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <h5 class="mb-0"><strong>
                                                                                @php
                                                                                    if (
                                                                                        $appointment->weight_kg == '' ||
                                                                                        $appointment->height_cm == ''
                                                                                    ) {
                                                                                        echo '-';
                                                                                    } else {
                                                                                        $bmi =
                                                                ...
                                                                <div class="col-6 be-1">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p class="mb-0 mt-0"><small
                                                                                class="vertical-align-super">mmHg</small>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row pt-5 ">
                                                                <div class="media-list  px-0">
                                                                        ...
                                                                        <div class="col-6 be-1">
                                                                            <div class="media media-single p-2 px-0">
                                                                                ...
                                                                                <div class="media-body">
                                                                                    ...
                                                                                    <small
                                                                                        class="text-fader text-muted">Smoking
                                                                                        status</small>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-6 ps-20">
                                                                            <div class="media media-single  p-2 px-0">
                                                                                ...
                                                                                <div class="media-body">
                                                                                    ...
                                                                                    <small
                                                                                        class="text-fader text-muted">Drinking
                                                                                        status</small>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div
                                                                        class="media media-single bt-1 pt-10  p-2 px-0">
                                                                        <div class="w-10"><i
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <small
                                                                                class="text-fader text-muted">Dieting
                                                                                status</small>
                                                                        </div>
                                                                    </div>
                                                                </div>
